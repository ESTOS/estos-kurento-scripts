...
./configure --target=x86-win32-gcc --prefix=/usr/i686-w64-mingw32/sys-root/mingw/ --extra-cflags=-mstackrealign
mingw32-make
pause
sudo mingw32-make install
cd ..
...
echo "3.22 openssl"
cd openssl/
./Configure shared no-sse2 --cross-compile-prefix=i686-w64-mingw32- mingw
mingw32-make depend
mingw32-make
