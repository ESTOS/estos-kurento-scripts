...
mingw64-cmake -DCMAKE_BUILD_TYPE=Debug ../kms-cmake-utils/
mingw64-make
pause
...
mingw64-configure --disable-tools --disable-tests --disable-benchmarks --disable-examples --enable-debug --libexec=/usr/x86_64-w64-mingw32/sys-root/mingw/libexec
make
pause
sudo make install
cd ..
...
mkdir jsoncpp-build
cd jsoncpp-build/
mingw64-cmake -DCMAKE_BUILD_TYPE=Debug ../jsoncpp
mingw64-make
pause
sudo mingw64-make install
cd ..
...
mingw64-cmake -DCMAKE_BUILD_TYPE=Debug -DCMAKE_MODULE_PATH=$cmakemodules ../kms-jsonrpc
pause
sudo mingw64-make install
cd ..
...
cd kms-core-build/
mingw64-cmake -DCMAKE_BUILD_TYPE=Debug -DCMAKE_MODULE_PATH=$cmakemodules -DCMAKE_INSTALL_PREFIX=/usr/x86_64-w64-mingw32/sys-root/mingw -DKURENTO_MODULES_DIR=/usr/x86_64-w64-mingw32/sys-root/mingw/share/kurento/modules/ ../kms-core
mingw64-make
pause
sudo mingw64-make install
cd ..
...
mingw64-cmake -DCMAKE_BUILD_TYPE=Debug -DCMAKE_MODULE_PATH=$cmakemodules -DCMAKE_INSTALL_PREFIX=/usr/x86_64-w64-mingw32/sys-root/mingw -DKURENTO_MODULES_DIR=/usr/x86_64-w64-mingw32/sys-root/mingw/share/kurento/modules/ ../kms-elements
mingw64-make
pause
sudo mingw64-make install
cd ..
