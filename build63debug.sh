...
git clone https://github.com/ESTOS/kms-cmake-utils.git -b estos6.3
...
git clone https://github.com/ESTOS/kurento-module-creator.git -b estos6.3
...
git clone https://github.com/ESTOS/gstreamer.git -b estos6.3
cd gstreamer/
...
git clone https://github.com/ESTOS/gst-plugins-base.git -b estos6.3
cd gst-plugins-base/
./autogen.sh ## Ignore configuration errors
...
echo "3.5 jsoncpp"
git clone https://github.com/ESTOS/jsoncpp.git -b estos6.3
mkdir jsoncpp-build
cd jsoncpp-build/
...
git clone https://github.com/ESTOS/kms-jsonrpc.git -b estos6.3
...
git clone https://github.com/ESTOS/kms-core.git -b estos6.3
...
echo "3.9 libevent"
git clone https://github.com/ESTOS/libevent.git -b estos6.3
cd libevent/
...
git clone https://github.com/ESTOS/kurento-media-server.git -b estos6.3
...
echo "3.11 usersctp"
git clone https://github.com/ESTOS/usrsctp.git -b estos6.3
cd usrsctp/
./bootstrap
mingw32-configure --enable-debug
mingw32-make
...
git clone https://github.com/ESTOS/openwebrtc-gst-plugins.git -b estos6.3
...
echo "3.13 libnice"
git clone https://github.com/ESTOS/libnice.git -b estos6.3
cd libnice/
./autogen.sh ## Ignore configuration errors
mingw32-configure --enable-debug
mingw32-make
...
git clone https://github.com/ESTOS/kms-elements.git -b estos6.3
...
git clone https://github.com/ESTOS/kms-filters.git -b estos6.3
...
git clone https://github.com/ESTOS/gst-plugins-good.git -b estos6.3
cd gst-plugins-good/
./autogen.sh
mingw32-configure \
...
git clone https://github.com/ESTOS/gst-plugins-bad.git -b estos6.3
cd gst-plugins-bad/
./autogen.sh
mingw32-configure \
