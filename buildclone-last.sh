...
cd kms-core
git checkout 5cd6a62f9a24845182129c46b8f8d4cb5d443e2f
cd ..
...
cd libnice
git checkout 50f84f98c134803f74b2d0fa70fbc83971473b2f
cd ..
git clone https://github.com/ESTOS/kms-elements.git
cd kms-elements
git checkout 5ad63d2bc06c736679930ec15bfed970dc60b7ba
cd ..
